...
// ====== KONFIG OVERLAY ======
const BOOKING_CLOSED = true; // <- ustaw na false, aby wyłączyć nakładkę
const CONTACT_PHONE = "+48 661 355 309"; // <- podmień na swój numer
// (opcjonalnie z env)
// const BOOKING_CLOSED = process.env.NEXT_PUBLIC_BOOKING_CLOSED === "true";
// const CONTACT_PHONE = process.env.NEXT_PUBLIC_CONTACT_PHONE ?? "+48 600 000 000";
// ============================
...
export default function BookPage() {
  ...
  const [hoursLoading, setHoursLoading] = useState(false); // ✅ loading godzin
  ...
  // ====== BLOKADA SCROLLA, gdy nakładka aktywna ======
  useEffect(() => {
    if (BOOKING_CLOSED) {
  ...
  return (
    <>
      {/* ====== zawartość strony, ukryta semantycznie gdy overlay ====== */}
      <div aria-hidden={BOOKING_CLOSED}>
        ...
        >
          ...
          >
            <div className="mb-4 inline-flex items-center justify-center w-14 h-14 rounded-full bg-red-100">
              <svg viewBox="0 0 24 24" className="w-7 h-7 text-red-600" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M12 9v4m0 4h.01" />
                <path d="M10 3h4l7 7v7a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V10l7-7z" />
              </svg>
            </div>
            ...
            <p className="mt-3 text-gray-600">
              Aktualnie nie mamy dostępnych slotów. Jeśli masz pytania lub chcesz zapisać się na listę
              oczekujących — zadzwoń.
            </p>
            ...
            <div className="mt-6">
              ...
              <p className="mt-3 text-sm text-gray-500">
                Preferujesz SMS lub WhatsApp? Użyj tego samego numeru.
              </p>
            </div>

            <p className="mt-8 text-xs text-gray-400">
              Rezerwacje chwilowo niedostępne. Tło zostało przyciemnione i rozmyte celowo.
            </p>
          </div>
        </div>
      )}
